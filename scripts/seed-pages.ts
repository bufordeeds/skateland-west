...
async function seedPages() {
  ...
  await payload.delete({
    ...
    where: {
      slug: {
        in: ['home', 'schedule', 'birthday-parties', 'private-events', 'learn-to-skate', 'about'],
      },
    },
  })
  ...
  console.log('Creating Birthday Parties page...')
  await payload.create({
    collection: 'pages',
    data: {
  ...
  console.log('Creating Private Events page...')
  await payload.create({
    collection: 'pages',
    data: {
  ...
  console.log('Creating Learn to Skate page...')
  await payload.create({
    collection: 'pages',
    data: {
